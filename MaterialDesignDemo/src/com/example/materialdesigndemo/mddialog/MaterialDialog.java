...
public class MaterialDialog {
	...
	private class Builder {
		...
		private Builder() {
			...
			mMessageContentRoot = (ViewGroup) mAlertDialogWindow
					.findViewById(R.id.message_content_root);
			if (mView != null) {
		...
		public void setContentView(View contentView) {
			...
			for (int i = 0; i < (linearLayout != null ? linearLayout
					.getChildCount() : 0); i++) {
		...
		public void setContentView(int layoutResId) {
			...
			// Not setting this to the other content view because user has
			// defined their own
			// layout params, and we don't want to overwrite those.
			LayoutInflater.from(mMessageContentRoot.getContext()).inflate(
					layoutResId, mMessageContentRoot);
		}
